...
<div class="home-wrapper">
  ...
  <div class="intro-text">
    ...
    <div class="button">
      <a href="https://github.com/yhanwen/soda.aboutapp.cn/releases/download/v1.1.2/Soda-1.1.2.dmg" download="SODA-1.0.0.dmg" class="download btn"><i class="icon-mac"></i><span v-html="$t('try_it_free')"></span></a>
    ...
    .button {
      .btn {
        ...
        &:hover {
          ...
          border:solid 1px darken(@orange, 0);
